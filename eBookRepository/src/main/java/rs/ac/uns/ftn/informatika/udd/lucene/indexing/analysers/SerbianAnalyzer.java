package rs.ac.uns.ftn.informatika.udd.lucene.indexing.analysers;
...
import rs.ac.uns.ftn.informatika.udd.lucene.indexing.filters.CyrilicToLatinFilter;

public class SerbianAnalyzer extends Analyzer {

	/**
	 * An array containing some common English words that are usually not useful for
	 * searching.
	 */
